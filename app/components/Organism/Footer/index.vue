      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <p class="text-gray-400 mb-6 leading-relaxed">
            ...
            global dengan berlandaskan ajaran Tamansiswa.
          </p>
          <div class="flex space-x-3">
            ...
            <a
              ...
              aria-label="Instagram STIE Tamansiswa"
            >
              <svg
            ...
            <!-- Facebook -->
            <a
              href="https://facebook.com/stietamansiswa"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-blue-600 transition-colors duration-300"
              aria-label="Facebook STIE Tamansiswa"
            >
              <svg
                class="w-6 h-6 fill-current"
                viewBox="0 0 24 24"
            ...
            <!-- LinkedIn -->
            <a
              href="https://linkedin.com/school/stie-tamansiswa"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-blue-700 transition-colors duration-300"
              aria-label="LinkedIn STIE Tamansiswa"
            >
              <svg
                class="w-6 h-6 fill-current"
                viewBox="0 0 24 24"
            ...
            <!-- YouTube -->
            <a
              href="https://youtube.com/@stietamansiswa"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-red-600 transition-colors duration-300"
              aria-label="YouTube STIE Tamansiswa"
            >
              <svg
                class="w-6 h-6 fill-current"
                viewBox="0 0 24 24"
            ...
            <!-- TikTok -->
            <a
              href="https://tiktok.com/@stietamansiswa"
              target="_blank"
              rel="noopener noreferrer"
              class="text-gray-400 hover:text-white transition-colors duration-300"
              aria-label="TikTok STIE Tamansiswa"
            >
              <svg
                class="w-6 h-6 fill-current"
                viewBox="0 0 24 24"
        ...
        <!-- Academic -->
        <div>
          <h3 class="text-lg font-bold mb-6">Akademik</h3>
          <ul class="space-y-4">
            <li>
              <a
                href="#"
